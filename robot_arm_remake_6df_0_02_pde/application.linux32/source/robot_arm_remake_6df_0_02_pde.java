...
public class robot_arm_remake_6df_0_02_pde extends PApplet {
...
public void controlEvent(ControlEvent theEvent) {
  switch(theEvent.getController().getId()) {
    ...
    if(groundinput==null)
      ...
      ground=PApplet.parseInt(groundinput);
      }
    ground++;
   ...
   if(tecinput==null)
    ...
    if(aboveinput==null)
      ...
      above = PApplet.parseInt(aboveinput);  
      }      
    ...
    if(clawinput==null)
      ...
      claw = PApplet.parseInt(clawinput);
      }
...
public void addMouseWheelListener() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "robot_arm_remake_6df_0_02_pde" };
    if (passedArgs != null) {
